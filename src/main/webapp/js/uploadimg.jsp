...
<LINK 
href="/nelecemarket/admin/images/syscome.files/Admin.css" rel=stylesheet>
<SCRIPT language=javascript src="/nelecemarket/admin/images/syscome.files/Admin.js"></SCRIPT>
...
if(filename!=null)
{
 ...
 txt.src="/nelecemarket/upfile/<%=filename%>";
 popclose();
 </script>
 <%} %>
<form action="/nelecemarket/nelecemarket?ac=uploadimg" enctype="multipart/form-data" name="f1" method="post">
...
if(suc!=null)
{
 %>
 alert("操作成功");
  parent.location.replace("/nelecemarket/admin/kcfiles.jsp");
 <%}%>
 </script>
