...
<BODY>
 ...
 <% 
	...
	if(!did.equals("")){
		dao.commOper("delete from shoucang where pid="+did+"");
	}
	dao.close();
%>
              ...
              <TR>
                <TD vAlign=top>
                  <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                    ...
                    String sql = "select * from pros where status='上架' and id in (select pid from shoucang where saver='"+Info.getUser(request).get("uname")+"')  ";
                          ...
                          <TR>
                            <TD vAlign=top>
                              ...
                              width="100%">
                                ...
                                </strong><a href="/nelecemarket/myshoucang.jsp?did=<%=m.get("id") %>">[移除]</a></DIV>
