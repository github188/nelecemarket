  ...
  <TR>
    <TD>
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        <TBODY>
        <TR>
          <TD><IMG src="nelecemarket_files/link.jpg" width=990 height=28></TD></TR>
        <TR>
          <TD>
            <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
              <TBODY>
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          <TD width="31%">
            ...
            border=0 src="nelecemarket_files/i.jpg" width=53 height=43></A>
            ...
            alt=我要啦免费统计 src="nelecemarket_files/go.htm"></A></NOSCRIPT> </DIV></TD>
          <TD width="69%">联系地址 ：街道口阜华大厦（流行视窗）C座8888室&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;027—88888888<BR>
            Copyright All Rights Reserved. 
            版权所有&nbsp;&nbsp;&nbsp;翻版必究<A href="http://www.jetsum.com/" 
            target=_blank></A> </TD>
