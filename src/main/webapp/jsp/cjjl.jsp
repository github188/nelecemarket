...
cDAO.insert(request,response,"messages",ext,true,false);
cDAO.close();
}
 %> --%>
...
<%
  ...
  %>
														<TBODY>
																													...
																													<TABLE id=standard border=0 cellSpacing=1
																														...
																														<TBODY>
																															...
																															<TR>
																																...
																																<TD width="89%" height="26" align=left
																															...
																															<TR>
																																<TD height="26" align=left vAlign=center
																																	bgColor=#ffffff style="color: gray">
																																	&nbsp; 相关商品 : <%-- <%=proinfo %> --%>
															...
															<tr>
																<td align="center" colspan="6" height="5"
																	valign="middle"></td>
															</tr>
														</TBODY>
														...
														<tr>
															<td align="center" colspan="6" height="6" valign="middle">
															</td>
														</tr>
