												...
												<TD height="177" vAlign=top>
													<TABLE width="100%" height="177" border=0 cellPadding=0
														...
														<TBODY>
															...
															<TR>
																<TD height="172">
																	<TABLE width="100%" height="145" border=0 cellPadding=0
																					...
																					<TABLE border=0 cellSpacing=0 cellPadding=0
																						...
																						<TBODY>
																							<TR>
																								<TD vAlign=top>
																									<form
																										action="/nelecemarket/nelecemarket?ac=flogin"
																										name="f1" method="post">
																															...
																															<TBODY>
																																<TR>
																																	<TD height="35" align=center
																																		vAlign=center>&nbsp;</TD>
																																	<TD height="35" align=center
																																		vAlign=center>用户名</TD>
																																	<TD width="542" height="35" align=left
																																		vAlign=center><span
																																		class="style1"> <input
																																...
																																<TR align=center>
																																	<TD height=1 colSpan=3
																																		background=nelecemarket_files/xjnews_11.gif></TD>
																																	<TD width="1" height=1
																																		background=nelecemarket_files/xjnews_11.gif></TD>
																																	<TD width="1" height=1
																																		background=nelecemarket_files/xjnews_11.gif></TD>
																																...
																																<TR>
																																	<TD width="297" height="35"
																																		align=center vAlign=center>&nbsp;</TD>
																																	<TD width="137" height="35"
																																		align=center vAlign=center>密码</TD>
																																...
																																<TR>
																																	<TD height="40" colspan="4"
																																		align=center vAlign=center><label>
																																			<input type="submit" name="button"
																																			id="button" value="提交信息">
																																			&nbsp;&nbsp;&nbsp; <input
																																			type="button" name="button2"
																																			id="button2" value="重新填写">
																																	</label></TD>
																																</TR>
																															</TBODY>
																														</TABLE>
